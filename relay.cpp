...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _ble.gattServer().onDataSent();

        cout << "After on data sent " << endl;

        print_mac_address();

        //cout << "MAC address = " << print_mac_address() << endl;
    ...
    void on_data_sent(const GattWriteCallbackParams *response) {
        if (response -> handle == _led_service->getValueHandle()) {
